...
{/*                 <div className="justify-between items-center gap-12 md:flex">
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-emerald-600 shadow-sm rounded-lg"
                                />
                            </div>
                            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 active:shadow-none rounded-lg shadow">
                                {data.button}
                            </button>
                        </form>
                    </div>
                ...
                <div className="mb-10 mt-10 items-center justify-between sm:flex">
                <p className="text-gray-300"></p>
                    <p className="text-gray-300">© 2024 parrot Inc. All rights reserved.</p>
