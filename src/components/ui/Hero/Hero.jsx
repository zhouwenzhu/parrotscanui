                ...
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center">
                        ...
                        <form
                            ...
                            <a  href={data.buttonLink} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-x-2 py-2.5 px-4 mt-3 w-full text-lg text-white font-medium bg-green-700 hover:bg-green-600 active:bg-green-800 duration-150 rounded-lg sm:mt-0 sm:w-auto">
                                 {data.buttonTitle}
...
{/*                         <div className="flex justify-center items-center gap-x-4 text-gray-400 text-sm">
                            ...
                            <p><span className="text-gray-100">5.0</span> by over 200k users</p>
                        </div> */}
                    </div>
                </div>
